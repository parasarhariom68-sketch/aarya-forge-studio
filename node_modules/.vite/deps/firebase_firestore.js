...
function __PRIVATE_isNumber(e) {
  return isInteger(e) || (function __PRIVATE_isDouble(e2) {
...
function __PRIVATE_toRunAggregationQueryRequest(e, t, n, r) {
  const { dt: i, parent: s } = __PRIVATE_toQueryTarget(e, t), o = {}, _ = [];
  let a = 0;
  return n.forEach(((e2) => {
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  let i;
  i = __PRIVATE_targetIsDocumentTarget(t.target) ? __PRIVATE_toDocumentsTarget(e.gt, t.target) : __PRIVATE_toQueryTarget(e.gt, t.target).dt;
...
var __PRIVATE_OrderedCodeWriter = class {
  ...
  Wt(e) {
    ...
    let n = t.next();
    for (; !n.done; ) this.Qt(n.value), n = t.next();
    this.Gt();
  }
  zt(e) {
    const t = e[Symbol.iterator]();
  ...
  Ht(e) {
    for (const t of e) {
      ...
      if (e2 < 128) this.Qt(e2);
      else if (e2 < 2048) this.Qt(960 | e2 >>> 6), this.Qt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t) this.Qt(480 | e2 >>> 12), this.Qt(128 | 63 & e2 >>> 6), this.Qt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
        this.Qt(240 | e3 >>> 18), this.Qt(128 | 63 & e3 >>> 12), this.Qt(128 | 63 & e3 >>> 6), this.Qt(128 | 63 & e3);
      }
    }
    this.Gt();
  }
  ...
  Xt(e) {
    const t = this.Yt(e), n = __PRIVATE_unsignedNumLength(t);
  ...
  Qt(e) {
    const t = 255 & e;
    0 === t ? (this.rn(0), this.rn(255)) : t === yt ? (this.rn(yt), this.rn(0)) : this.rn(t);
  }
  /** Writes a single byte descending to the buffer.  */
  jt(e) {
    const t = 255 & e;
    0 === t ? (this._n(0), this._n(255)) : t === yt ? (this._n(yt), this._n(0)) : this._n(e);
  }
  Gt() {
    this.rn(0), this.rn(1);
  }
...
var __PRIVATE_IndexByteEncoder = class {
  constructor() {
    this.un = new __PRIVATE_OrderedCodeWriter(), this.ascending = new __PRIVATE_AscendingIndexByteEncoder(this.un), this.descending = new __PRIVATE_DescendingIndexByteEncoder(this.un);
  }
  seed(e) {
    this.un.seed(e);
  }
...
var __PRIVATE_IndexEntry = class ___PRIVATE_IndexEntry {
  constructor(e, t, n, r) {
    this.ln = e, this.hn = t, this.Pn = n, this.Tn = r;
  }
  /**
   ...
   */
  In() {
    const e = this.Tn.length, t = 0 === e || 255 === this.Tn[e - 1] ? e + 1 : e, n = new Uint8Array(t);
    return n.set(this.Tn, 0), t !== e ? n.set([0], this.Tn.length) : ++n[n.length - 1], new ___PRIVATE_IndexEntry(this.ln, this.hn, this.Pn, n);
  }
  ...
  En(e, t, n) {
    return {
      indexId: this.ln,
      uid: e,
      arrayValue: __PRIVATE_encodeKeySafeBytes(this.Pn),
      directionalValue: __PRIVATE_encodeKeySafeBytes(this.Tn),
...
function __PRIVATE_indexEntryComparator(e, t) {
  let n = e.ln - t.ln;
  return 0 !== n ? n : (n = __PRIVATE_compareByteArrays(e.Pn, t.Pn), 0 !== n ? n : (n = __PRIVATE_compareByteArrays(e.Tn, t.Tn), 0 !== n ? n : DocumentKey.comparator(e.hn, t.hn)));
}
...
var __PRIVATE_TargetIndexMatcher = class {
  constructor(e) {
    this.An = new SortedSet(((e2, t) => FieldPath$1.comparator(e2.field, t.field))), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.Vn = e.orderBy, this.dn = [];
    for (const t of e.filters) {
      const e2 = t;
      e2.isInequality() ? this.An = this.An.add(e2) : this.dn.push(e2);
    }
  }
  get mn() {
   ...
   */
  fn(e) {
    if (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId, 49279), this.mn)
      return false;
    const t = __PRIVATE_fieldIndexGetArraySegment(e);
    if (void 0 !== t && !this.gn(t)) return false;
    const n = __PRIVATE_fieldIndexGetDirectionalSegments(e);
    let r = /* @__PURE__ */ new Set(), i = 0, s = 0;
    for (; i < n.length && this.gn(n[i]); ++i) r = r.add(n[i].fieldPath.canonicalString());
    if (i === n.length) return true;
    if (this.An.size > 0) {
      const e2 = this.An.getIterator().getNext();
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.pn(e2, t2) || !this.yn(this.Vn[s++], t2)) return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.Vn.length || !this.yn(this.Vn[s++], e2)) return false;
    }
    return true;
  }
  /**
  ...
  gn(e) {
    for (const t of this.dn) if (this.pn(t, e)) return true;
    return false;
  }
  pn(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
     ...
     */
    this.Dn = new ObjectMap(((e2) => __PRIVATE_canonifyTarget(e2)), ((e2, t2) => __PRIVATE_targetEquals(e2, t2))), this.uid = e.uid || "";
  }
  /**
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.Cn(t), ((t2) => this.getIndexType(e, t2).next(((n) => {
      if (0 === n || 1 === n) {
        const n2 = new __PRIVATE_TargetIndexMatcher(t2).wn();
  ...
  getDocumentsMatchingTarget(e, t) {
    ...
    return PersistencePromise.forEach(this.Cn(t), ((t2) => this.vn(e, t2).next(((e2) => {
      r && (r = !!e2), i.set(t2, e2);
    })))).next((() => {
      if (r) {
        ...
        return PersistencePromise.forEach(i, ((i2, s) => {
          ...
          const o = (function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r3);
          })(s, i2), c = this.Fn(i2, s, a), l = this.Fn(i2, s, u), h = this.Mn(i2, s, _), P = this.xn(i2.indexId, o, c, a.inclusive, l, u.inclusive, h);
  ...
  xn(e, t, n, r, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.On(t[c / a]) : bt, l = this.Nn(e, _2, n[c % a], r), h = this.Bn(e, _2, i[c % a], s), P = o.map(((t2) => this.Nn(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  vn(e, t) {
    ...
    return this.getFieldIndexes(e, r).next(((e2) => {
      let t2 = null;
      for (const r2 of e2) {
        n.fn(r2) && (!t2 || r2.fields.length > t2.fields.length) && (t2 = r2);
      }
      return t2;
    }));
  }
  getIndexType(e, t) {
    let n = 2;
    const r = this.Cn(t);
    return PersistencePromise.forEach(r, ((t2) => this.vn(e, t2).next(((e2) => {
  ...
  Ln(e, t) {
    ...
    for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      const i = n.cn(r.kind);
      __PRIVATE_FirestoreIndexValueWriter.$t.bt(e2, i);
    }
    return n.an();
  }
  ...
  On(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.$t.bt(e, t.cn(
      0
      /* IndexKind.ASCENDING */
    )), t.an();
  }
  ...
  kn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.$t.bt(__PRIVATE_refValue(this.databaseId, t), n.cn((function __PRIVATE_fieldIndexGetKeyOrder(e2) {
  ...
  Mn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r) if (this.qn(t, s.fieldPath) && isArray(e2)) r = this.Kn(r, s, e2);
      else {
        const t2 = n2.cn(s.kind);
        __PRIVATE_FirestoreIndexValueWriter.$t.bt(e2, t2);
      }
    }
    return this.Un(r);
  }
  ...
  Kn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || []) for (const n2 of r) {
      ...
      r2.seed(n2.an()), __PRIVATE_FirestoreIndexValueWriter.$t.bt(e2, r2.cn(t.kind)), i.push(r2);
    }
    return i;
  }
  qn(e, t) {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.$n(e).next(((e2) => r.J(be, IDBKeyRange.bound(t, t)).next(((t2) => PersistencePromise.forEach(t2, ((t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n))))))));
  }
  updateIndexEntries(e, t) {
    ...
    return PersistencePromise.forEach(t, ((t2, r) => {
      ...
      return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t2.collectionGroup)).next(((i2) => (n.set(t2.collectionGroup, i2), PersistencePromise.forEach(i2, ((n2) => this.Wn(e, t2, n2).next(((t3) => {
        const i3 = this.Qn(r, n2);
        return t3.isEqual(i3) ? PersistencePromise.resolve() : this.Gn(e, r, n2, t3, i3);
      })))))));
    }));
  }
  zn(e, t, n, r) {
    return __PRIVATE_indexEntriesStore(e).put(r.En(this.uid, this.kn(n, t.key), t.key));
  }
  jn(e, t, n, r) {
    return __PRIVATE_indexEntriesStore(e).delete(r.Rn(this.uid, this.kn(n, t.key), t.key));
  }
  Wn(e, t, n) {
  ...
  Qn(e, t) {
    ...
    if (null != i) {
      ...
      if (isArray(s)) for (const i2 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.On(i2), r));
  ...
  createRange(e, t, n) {
    ...
    for (let e2 = 0; e2 < r.length; e2 += 2) {
      ...
      const t2 = r[e2].Rn(this.uid, bt, DocumentKey.empty()), n2 = r[e2 + 1].Rn(this.uid, bt, DocumentKey.empty());
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.Cn(t), ((t2) => this.vn(e, t2).next(((e2) => e2 || fail(44426))))).next(__PRIVATE_getMinOffsetFromFieldIndexes);
  }
};
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  ...
  // PORTING NOTE: Multi-tab only.
  Zn(e, t) {
    return this.Hn[t] ? PersistencePromise.resolve(this.Hn[t]) : this.lookupMutationBatch(e, t).next(((e2) => {
      if (e2) {
        const n = e2.keys();
        return this.Hn[t] = n, n;
      }
      return null;
    }));
  }
  ...
  getAllMutationBatchesAffectingDocumentKeys(e, t) {
    ...
    return t.forEach(((t2) => {
      ...
      r.push(o);
    })), PersistencePromise.waitFor(r).next((() => this.er(e, n)));
  }
    ...
    return this.checkEmpty(e).next(((t) => {
      ...
      return __PRIVATE_documentMutationsStore(e).ee({
        ...
        __PRIVATE_hardAssert(0 === r.length, 56720, {
          nr: r.map(((e2) => e2.canonicalString()))
        });
      }));
    }));
  }
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  allocateTargetId(e) {
    return this.ar(e).next(((t) => {
      const n = new __PRIVATE_TargetIdGenerator(t.highestTargetId);
      return t.highestTargetId = n.next(), this.ur(e, t).next((() => t.highestTargetId));
    }));
  }
  getLastRemoteSnapshotVersion(e) {
    return this.ar(e).next(((e2) => SnapshotVersion.fromTimestamp(new Timestamp(e2.lastRemoteSnapshotVersion.seconds, e2.lastRemoteSnapshotVersion.nanoseconds))));
  }
  getHighestSequenceNumber(e) {
    return this.ar(e).next(((e2) => e2.highestListenSequenceNumber));
  }
  setTargetsMetadata(e, t, n) {
    return this.ar(e).next(((r) => (r.highestListenSequenceNumber = t, n && (r.lastRemoteSnapshotVersion = n.toTimestamp()), t > r.highestListenSequenceNumber && (r.highestListenSequenceNumber = t), this.ur(e, r))));
  }
  addTargetData(e, t) {
    return this.cr(e, t).next((() => this.ar(e).next(((n) => (n.targetCount += 1, this.lr(t, n), this.ur(e, n))))));
  }
  updateTargetData(e, t) {
    return this.cr(e, t);
  }
  removeTargetData(e, t) {
    return this.removeMatchingKeysForTargetId(e, t.targetId).next((() => __PRIVATE_targetsStore(e).delete(t.targetId))).next((() => this.ar(e))).next(((t2) => (__PRIVATE_hardAssert(t2.targetCount > 0, 8065), t2.targetCount -= 1, this.ur(e, t2))));
  }
  /**
  ...
  getTargetCount(e) {
    return this.ar(e).next(((e2) => e2.targetCount));
  }
  getTargetData(e, t) {
...
var __PRIVATE_IndexedDbLruDelegateImpl = class {
  ...
  removeOrphanedDocuments(e, t) {
    ...
    let i = 0;
    return this.pr(e, ((s, o) => {
      if (o <= t) {
        const t2 = this.yr(e, s).next(((t3) => {
          if (!t3)
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
   ...
   */
  updateMetadata(e, t) {
    return this.getMetadata(e).next(((n) => (n.byteSize += t, this.wr(e, n))));
  }
  getEntry(e, t) {
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
   ...
   */
  constructor(e, t) {
    super(), this.Fr = e, this.trackRemovals = t, // A map of document sizes and read times prior to applying the changes in
    // this buffer.
    this.Mr = new ObjectMap(((e2) => e2.toString()), ((e2, t2) => e2.isEqual(t2)));
  }
  applyChanges(e) {
    const t = [];
    ...
    return this.changes.forEach(((i, s) => {
      const o = this.Mr.get(i);
      if (t.push(this.Fr.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
        const _ = __PRIVATE_toDbRemoteDocument(this.Fr.serializer, s);
        r = r.add(i.path.popLast());
        const a = __PRIVATE_dbDocumentSize(_);
        n += a - o.size, t.push(this.Fr.addEntry(e, i, _));
      } else if (n -= o.size, this.trackRemovals) {
        const n2 = __PRIVATE_toDbRemoteDocument(this.Fr.serializer, s.convertToNoDocument(SnapshotVersion.min()));
        t.push(this.Fr.addEntry(e, i, n2));
      }
    })), r.forEach(((n2) => {
      t.push(this.Fr.indexManager.addToCollectionParentIndex(e, n2));
    })), t.push(this.Fr.updateMetadata(e, n)), PersistencePromise.waitFor(t);
  }
  getFromCache(e, t) {
    return this.Fr.br(e, t).next(((e2) => (this.Mr.set(t, {
      size: e2.size,
      readTime: e2.document.readTime
    }), e2.document)));
  }
  getAllFromCache(e, t) {
    return this.Fr.Cr(e, t).next((({ documents: e2, vr: t2 }) => (
...
var __PRIVATE_MemoryBundleCache = class {
  ...
  saveNamedQuery(e, t) {
    return this.Nr.set(t.name, (function __PRIVATE_fromProtoNamedQuery(e2) {
      return {
        name: e2.name,
...
var __PRIVATE_MemoryPersistence = class {
  ...
  constructor(e, t) {
    ...
    })(((e2) => this.referenceDelegate.li(e2))), this.serializer = new __PRIVATE_LocalSerializer(t), this.hi = new __PRIVATE_MemoryBundleCache(this.serializer);
  }
  start() {
...
var __PRIVATE_SchemaConverter = class {
  ...
  k(e, t, n, r) {
    ...
    }))), n < 5 && r >= 5 && (s = s.next((() => this.fi(i)))), n < 6 && r >= 6 && (s = s.next((() => ((function __PRIVATE_createDocumentGlobalStore(e2) {
      e2.createObjectStore(oe);
    })(e), this.gi(i))))), n < 7 && r >= 7 && (s = s.next((() => this.pi(i)))), n < 8 && r >= 8 && (s = s.next((() => this.yi(e, i)))), n < 9 && r >= 9 && (s = s.next((() => {
    ...
    }))), n < 10 && r >= 10 && (s = s.next((() => this.wi(i)))), n < 11 && r >= 11 && (s = s.next((() => {
    ...
    })(e))).next((() => this.Si(e, i))).next((() => e.deleteObjectStore($)))), n < 14 && r >= 14 && (s = s.next((() => this.bi(e, i)))), n < 15 && r >= 15 && (s = s.next((() => (function __PRIVATE_createFieldIndex(e2) {
  ...
  bi(e, t) {
    const n = t.store(j), r = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Ai, this.serializer.gt);
    return n.J().next(((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Di = i, this.window = s, this.document = o, this.Ci = a, this.Fi = u, this.Mi = c, this._i = null, this.ai = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
    this.xi = null, this.inForeground = false, /** Our 'visibilitychange' listener if registered. */
    this.Oi = null, /** The client metadata refresh task. */
    this.Ni = null, /** The last time we garbage collected the client metadata object store. */
    this.Bi = Number.NEGATIVE_INFINITY, /** A listener to notify on primary state changes. */
    this.Li = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v()) throw new FirestoreError(D.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.ki = t + Nt, this.serializer = new __PRIVATE_LocalSerializer(_), this.qi = new __PRIVATE_SimpleDb(this.ki, this.Mi, new __PRIVATE_SchemaConverter(this.serializer)), this.ui = new __PRIVATE_IndexedDbGlobalsCache(), this.ci = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.hi = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.Ki = this.window.localStorage : (this.Ki = null, false === u && __PRIVATE_logError(Ft, "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  start() {
    return this.Ui().then((() => {
      if (!this.isPrimary && !this.allowTabSynchronization)
        throw new FirestoreError(D.FAILED_PRECONDITION, Ot);
      return this.$i(), this.Wi(), this.Qi(), this.runTransaction("getHighestListenSequenceNumber", "readonly", ((e) => this.ci.getHighestSequenceNumber(e)));
    })).then(((e) => {
      this._i = new __PRIVATE_ListenSequence(e, this.Ci);
    })).then((() => {
      this.ai = true;
  ...
  setNetworkEnabled(e) {
    ...
    this.Di.enqueueAndForget((async () => {
  ...
  Ui() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (this.isPrimary) return this.zi(e).next(((e2) => {
        e2 || (this.isPrimary = false, this.Di.enqueueRetryable((() => this.Li(false))));
      }));
    })).next((() => this.ji(e))).next(((t) => this.isPrimary && !t ? this.Ji(e).next((() => false)) : !!t && this.Hi(e).next((() => true)))))).catch(((e) => {
      ...
      this.isPrimary !== e && this.Di.enqueueRetryable((() => this.Li(e))), this.isPrimary = e;
    }));
  }
  zi(e) {
    return __PRIVATE_primaryClientStore(e).get(Q).next(((e2) => PersistencePromise.resolve(this.Zi(e2))));
  }
  Xi(e) {
   ...
   */
  async Yi() {
    if (this.isPrimary && !this.es(this.Bi, Mt)) {
      this.Bi = Date.now();
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e2) => {
        ...
        return t.J().next(((e3) => {
          const n = this.ts(e3, Mt), r = e3.filter(((e4) => -1 === n.indexOf(e4)));
          return PersistencePromise.forEach(r, ((e4) => t.delete(e4.clientId))).next((() => r));
        }));
      })).catch((() => []));
      if (this.Ki) for (const t of e) this.Ki.removeItem(this.ns(t.clientId));
    }
  }
  /**
   ...
   */
  Qi() {
    this.Ni = this.Di.enqueueAfterDelay("client_metadata_refresh", 4e3, (() => this.Ui().then((() => this.Yi())).then((() => this.Qi()))));
  }
   ...
   */
  ji(e) {
    if (this.Fi) return PersistencePromise.resolve(true);
    return __PRIVATE_primaryClientStore(e).get(Q).next(((t) => {
      if (null !== t && this.es(t.leaseTimestampMs, xt) && !this.rs(t.ownerId)) {
        if (this.Zi(t) && this.networkEnabled) return true;
        if (!this.Zi(t)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).J().next(((e2) => void 0 === this.ts(e2, xt).find(((e3) => {
  ...
  async shutdown() {
    this.ai = false, this.ss(), this.Ni && (this.Ni.cancel(), this.Ni = null), this._s(), this.us(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
    ...
    await this.qi.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
      ...
      return this.Ji(t).next((() => this.Xi(t)));
   ...
   */
  ts(e, t) {
    return e.filter(((e2) => this.es(e2.updateTimeMs, t) && !this.rs(e2.clientId)));
  }
  /**
   ...
   */
  ls() {
    return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).J().next(((e2) => this.ts(e2, Mt).map(((e3) => e3.clientId))))));
  }
  get started() {
    return this.ai;
  }
  ...
  runTransaction(e, t, n) {
    ...
    let s;
    return this.qi.runTransaction(e, r, i, ((r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this._i ? this._i.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.zi(s).next(((e2) => !!e2 || this.ji(s))).next(((t2) => {
      if (!t2) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Di.enqueueRetryable((() => this.Li(false))), new FirestoreError(D.FAILED_PRECONDITION, B);
      return n(s);
    })).next(((e2) => this.Hi(s).next((() => e2)))) : this.hs(s).next((() => n(s)))))).then(((e2) => (s.raiseOnCommittedEvent(), e2)));
  }
  /**
  ...
  hs(e) {
    return __PRIVATE_primaryClientStore(e).get(Q).next(((e2) => {
      if (null !== e2 && this.es(e2.leaseTimestampMs, xt) && !this.rs(e2.ownerId) && !this.Zi(e2) && !(this.Fi || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(D.FAILED_PRECONDITION, Ot);
    }));
  }
  /**
  ...
  Ji(e) {
    ...
    return t.get(Q).next(((e2) => this.Zi(e2) ? (__PRIVATE_logDebug(Ft, "Releasing primary lease."), t.delete(Q)) : PersistencePromise.resolve()));
  }
  ...
  $i() {
    null !== this.document && "function" == typeof this.document.addEventListener && (this.Oi = () => {
      this.Di.enqueueAndForget((() => (this.inForeground = "visible" === this.document.visibilityState, this.Ui())));
    }, this.document.addEventListener("visibilitychange", this.Oi), this.inForeground = "visible" === this.document.visibilityState);
  }
  _s() {
    this.Oi && (this.document.removeEventListener("visibilitychange", this.Oi), this.Oi = null);
  }
  /**
   ...
   */
  Wi() {
    "function" == typeof this.window?.addEventListener && (this.xi = () => {
      this.ss();
      ...
      this.Di.enterRestrictedMode(
        /* purgeExistingTasks= */
        true
      ), this.Di.enqueueAndForget((() => this.shutdown()));
    }, this.window.addEventListener("pagehide", this.xi));
  }
  us() {
    this.xi && (this.window.removeEventListener("pagehide", this.xi), this.xi = null);
  }
  /**
  ...
  rs(e) {
    try {
      const t = null !== this.Ki?.getItem(this.ns(e));
  ...
  ss() {
    if (this.Ki) try {
      this.Ki.setItem(this.ns(this.clientId), String(Date.now()));
    } catch (e) {
  ...
  cs() {
    if (this.Ki) try {
      this.Ki.removeItem(this.ns(this.clientId));
    } catch (e) {
    }
  }
  ns(e) {
    ...
    t.targetChanges.forEach(((s2, _2) => {
      ...
      */
      (function __PRIVATE_shouldPersistTargetData(e3, t2, n2) {
        ...
        return i2 > 0;
      })(a2, u, s2) && o.push(n.ci.updateTargetData(e2, u));
    }));
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r = __PRIVATE_debugCast(n.ci), i = n.Cs.get(t);
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  const n = __PRIVATE_debugCast(e), r = n.Fs.get(t) || SnapshotVersion.min();
  return n.persistence.runTransaction("Get new document changes", "readonly", ((e2) => n.Ms.getAllFromCollectionGroup(
    e2,
    t,
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", ((e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next(((t2) => (_.apply(e2), t2))).next(((t2) => i.ci.removeMatchingKeysForTargetId(e2, a.targetId).next((() => i.ci.addMatchingKeys(e2, s, a.targetId))).next((() => i.localDocuments.getLocalViewOfDocuments(e2, t2.Ns, t2.Bs))).next((() => t2.Ns))))));
}
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", ((e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0) return i.hi.saveNamedQuery(e2, t);
    const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
    return i.Cs = i.Cs.insert(o.targetId, o), i.ci.updateTargetData(e2, o).next((() => i.ci.removeMatchingKeysForTargetId(e2, r.targetId))).next((() => i.ci.addMatchingKeys(e2, n, r.targetId))).next((() => i.hi.saveNamedQuery(e2, t)));
  }));
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.Di = t, this.persistenceKey = n, this.Gs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.zs = this.js.bind(this), this.Js = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.Hs = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Zs = createWebStorageClientStateKey(this.persistenceKey, this.Gs), this.Xs = /** Assembles the key for the current sequence number. */
    (function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    })(this.persistenceKey), this.Js = this.Js.insert(this.Gs, new __PRIVATE_LocalClientState()), this.Ys = new RegExp(`^${kt}_${s}_([^_]*)$`), this.eo = new RegExp(`^${Kt}_${s}_(\\d+)(?:_(.*))?$`), this.no = new RegExp(`^${qt}_${s}_(\\d+)$`), this.ro = /** Assembles the key for the online state of the primary tab. */
    (function createWebStorageOnlineStateKey(e2) {
      return `firestore_online_state_${e2}`;
    })(this.persistenceKey), this.io = (function createBundleLoadedKey(e2) {
    ...
    this.window.addEventListener("storage", this.zs);
  }
  ...
  async start() {
    const e = await this.syncEngine.ls();
    for (const t2 of e) {
      if (t2 === this.Gs) continue;
      const e2 = this.getItem(createWebStorageClientStateKey(this.persistenceKey, t2));
      if (e2) {
        const n = __PRIVATE_RemoteClientState.Us(t2, e2);
        n && (this.Js = this.Js.insert(n.clientId, n));
      }
    }
    this.so();
    const t = this.storage.getItem(this.ro);
    if (t) {
      const e2 = this.oo(t);
      e2 && this._o(e2);
    }
    for (const e2 of this.Hs) this.js(e2);
    this.Hs = [], // Register a window unload hook to remove the client metadata entry from
    // WebStorage even if `shutdown()` was not called.
    this.window.addEventListener("pagehide", (() => this.shutdown())), this.started = true;
  }
  writeSequenceNumber(e) {
    this.setItem(this.Xs, JSON.stringify(e));
  }
  getAllActiveQueryTargets() {
    return this.ao(this.Js);
  }
  ...
  updateMutationState(e, t, n) {
    this.uo(e, t, n), // Once a final mutation result is observed by other clients, they no longer
  ...
  addLocalQueryTarget(e, t = true) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (t2) {
        const r = __PRIVATE_QueryTargetMetadata.Us(e, t2);
        r && (n = r.state);
      }
    }
    return t && this.lo.Ws(e), this.so(), n;
  }
  removeLocalQueryTarget(e) {
    this.lo.Qs(e), this.so();
  }
  isLocalQueryTarget(e) {
    return this.lo.activeTargetIds.has(e);
  }
  clearQueryState(e) {
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this.zs), this.removeItem(this.Zs), this.started = false);
  }
  getItem(e) {
  ...
  js(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Ut, "EVENT", t.key, t.newValue), t.key === this.Zs) return void __PRIVATE_logError("Received WebStorage notification for local change. Another client might have garbage-collected our state");
      this.Di.enqueueRetryable((async () => {
        if (this.started) {
          if (null !== t.key) {
            if (this.Ys.test(t.key)) {
            ...
            } else if (this.eo.test(t.key)) {
              if (null !== t.newValue) {
                const e2 = this.Ao(t.key, t.newValue);
                if (e2) return this.Vo(e2);
              }
              ...
              if (null !== t.newValue) {
                const e2 = this.oo(t.newValue);
                if (e2) return this._o(e2);
              }
              ...
              const e2 = this.yo(t.newValue);
              await Promise.all(e2.map(((e3) => this.syncEngine.wo(e3))));
            }
          }
        } else this.Hs.push(t);
      }));
  ...
  get lo() {
    return this.Js.get(this.Gs);
  }
  so() {
    this.setItem(this.Zs, this.lo.$s());
  }
  uo(e, t, n) {
  ...
  Po(e) {
    ...
    this.storage.setItem(this.ro, JSON.stringify(t));
  }
  ho(e, t, n) {
  ...
  Ro(e, t) {
    const n = this.Io(e);
    return __PRIVATE_RemoteClientState.Us(n, t);
  }
  /**
   ...
   */
  Ao(e, t) {
    const n = this.eo.exec(e), r = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
    return __PRIVATE_MutationMetadata.Us(new User(i), r, t);
  }
  /**
   ...
   */
  mo(e, t) {
    const n = this.no.exec(e), r = Number(n[1]);
    return __PRIVATE_QueryTargetMetadata.Us(r, t);
  }
  /**
   ...
   */
  oo(e) {
    return __PRIVATE_SharedOnlineState.Us(e);
  }
  yo(e) {
    return JSON.parse(e);
  }
  ...
  fo(e) {
    return this.syncEngine.bo(e.targetId, e.state, e.error);
  }
  Eo(e, t) {
    const n = t ? this.Js.insert(e, t) : this.Js.remove(e), r = this.ao(this.Js), i = this.ao(n), s = [], o = [];
    return i.forEach(((e2) => {
      r.has(e2) || s.push(e2);
    })), r.forEach(((e2) => {
      i.has(e2) || o.push(e2);
    })), this.syncEngine.Do(s, o).then((() => {
      this.Js = n;
    }));
  }
  _o(e) {
...
var __PRIVATE_SizedBundleElement = class {
  constructor(e, t) {
    this.Wa = e, this.byteLength = t;
  }
  Qa() {
    return "metadata" in this.Wa;
  }
};
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  qs(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.ks(e.metadata.name), this.Ks(e.metadata.readTime));
  }
  Ks(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t) {
    this.Ga = e, this.serializer = t, /** Batched queries to be saved into storage */
    this.za = [], /** Batched documents to be saved into storage */
  ...
  Ja(e) {
    ...
    if (e.Wa.namedQuery) this.za.push(e.Wa.namedQuery);
    else if (e.Wa.documentMetadata) {
      this.ja.push({
        metadata: e.Wa.documentMetadata
      }), e.Wa.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.Wa.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else e.Wa.document && (this.ja[this.ja.length - 1].document = e.Wa.document, ++t);
   ...
   */
  async Za(e) {
    const t = await __PRIVATE_localStoreApplyBundledDocuments(e, new __PRIVATE_BundleConverterImpl(this.serializer), this.ja, this.Ga.id), n = this.Ha(this.documents);
    for (const t2 of this.za) await __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
    return this.progress.taskState = "Success", {
      progress: this.progress,
      Xa: this.collectionGroups,
      Ya: t
    };
  }
};
...
var __PRIVATE_View = class {
  ...
  applyChanges(e, t, n, r) {
    ...
    })(e2.type, t2.type) || this.ru(e2.doc, t2.doc))), this.uu(n), r = r ?? false;
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.Su = (t2, n2, r2) => (async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
  ...
  if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
    ...
    })(r.eventManager, t), e2.length && r.Eu.J_(e2), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
  }
}
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  ...
  })), await Promise.all(o), r.Eu.J_(i), await (async function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.lu), i;
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  const i = __PRIVATE_debugCast(e), s = await (function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
    ...
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", ((e3) => r2.Zn(e3, t2).next(((t3) => t3 ? n2.localDocuments.getDocuments(e3, t3) : PersistencePromise.resolve(null)))));
  })(i.localStore, t);
  null !== s ? ("pending" === n ? (
    ...
    (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), (function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
      __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).tr(t2);
    })(i.localStore, t))
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.wu) {
    ...
    n.wu = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2) __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.wu) {
    const e2 = [];
    ...
    (function __PRIVATE_resetLimboDocuments(e3) {
      ...
      })), t3.fu.Gr(), t3.mu = /* @__PURE__ */ new Map(), t3.du = new SortedMap(DocumentKey.comparator);
    })(n), n.wu = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
...
function __PRIVATE_syncEngineGetActiveClients(e) {
  return (function __PRIVATE_localStoreGetActiveClients(e2) {
    return __PRIVATE_debugCast(__PRIVATE_debugCast(e2).persistence).ls();
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.wu) {
    for (const e2 of t) {
      if (r.Au.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
    ...
    for (const e2 of n)
      r.Au.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        /* keepPersistedTargetData */
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      if (await (function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", ((e4) => n3.hi.getBundleMetadata(e4, t3.id))).then(((e4) => !!e4 && e4.createTime.compareTo(r3) >= 0));
      ...
      let s = await t2.vu();
      for (; s; ) {
        const e3 = await i.Ja(s);
        e3 && n2._updateProgress(e3), s = await t2.vu();
      }
      ...
      await (function __PRIVATE_localStoreSaveBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("Save bundle", "readwrite", ((e4) => n3.hi.saveBundleMetadata(e4, t3)));
      })(e2.localStore, r2), n2._completeWith(o.progress), Promise.resolve(o.Xa);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Bu = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.kind = "persistent", this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Bu.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Bu.syncEngine), await __PRIVATE_fillWritePipeline(this.Bu.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Bu = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    await super.initialize(e);
    const t = this.Bu.syncEngine;
    this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
      ...
      bo: __PRIVATE_syncEngineApplyTargetState.bind(null, t),
      Do: __PRIVATE_syncEngineApplyActiveTargetsChange.bind(null, t),
      ls: __PRIVATE_syncEngineGetActiveClients.bind(null, t),
      wo: __PRIVATE_syncEngineSynchronizeWithChangedDocuments.bind(null, t)
    ...
    await this.persistence.Gi((async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Bu.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    }));
  }
  Fu(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
     ...
     * content.
     */
    this.buffer = new Uint8Array(), this.Ku = (function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    })(), // Read the metadata (which is the first element).
    this.Uu().then(((e2) => {
      e2 && e2.Qa() ? this.metadata.resolve(e2.Wa.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(e2?.Wa)}`));
  ...
  async vu() {
    return await this.getMetadata(), this.Uu();
  }
  /**
  ...
  async Uu() {
    ...
    if (null === e) return null;
    const t = this.Ku.decode(e), n = Number(t);
    isNaN(n) && this.Wu(`length string (${t}) is not valid number`);
  ...
  async $u() {
    for (; this.Gu() < 0; ) {
      if (await this.zu()) break;
    }
    if (0 === this.buffer.length) return null;
    const e = this.Gu();
    e < 0 && this.Wu("Reached the end of bundle when a length string is expected.");
  ...
  async Qu(e) {
    for (; this.buffer.length < e; ) {
      await this.zu() && this.Wu("Reached the end of bundle when more is expected.");
    }
    const t = this.Ku.decode(this.buffer.slice(0, e));
    return this.buffer = this.buffer.slice(e), t;
  }
  Wu(e) {
...
var __PRIVATE_BundleReaderSyncImpl = class {
  constructor(e, t) {
    ...
    this.metadata = n;
    do {
      n = this.vu(), null !== n && this.elements.push(n);
    } while (null !== n);
  }
...
var Transaction = class {
  ...
  async lookup(e) {
    ...
    const t = await (async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, i = await n.zo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
      i.forEach(((e3) => {
  ...
  async commit() {
    ...
    e.forEach(((e2, t) => {
      ...
      await n.$o("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Hu = n.maxAttempts, this.F_ = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Xu() {
    this.F_.g_((async () => {
      const e = new Transaction(this.datastore), t = this.Yu(e);
      t && t.then(((t2) => {
  ...
  ec(e) {
    this.Hu > 0 && this.tc(e) ? (this.Hu -= 1, this.asyncQueue.enqueueAndForget((() => (this.Xu(), Promise.resolve())))) : this.deferred.reject(e);
  }
  tc(e) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => (async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.Ls), s = i.ou(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
  ...
  return e.asyncQueue.enqueueAndForget((async () => {
    try {
      ...
      r.resolve((async function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        const r2 = __PRIVATE_debugCast(e2), { request: i2, ft: s, parent: o } = __PRIVATE_toRunAggregationQueryRequest(r2.serializer, __PRIVATE_queryToAggregateTarget(t2), n2);
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => (function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).Ma.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
    ...
    n.ku(), e.asyncQueue.enqueueAndForget((async () => (function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).Ma.delete(t2);
    })(await __PRIVATE_getEventManager(e), n)));
  };
}
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
  return e.asyncQueue.enqueue((async () => (function __PRIVATE_localStoreGetNamedQuery(e2, t2) {
    ...
    return n.persistence.runTransaction("Get named query", "readonly", ((e3) => n.hi.getNamedQuery(e3, t2)));
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
  return e.asyncQueue.enqueue((async () => (function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e2, t2) {
    __PRIVATE_debugCast(e2).Ds.Rs = t2;
  })(await __PRIVATE_getLocalStore(e), t)));
}
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.dataSource) throw 1 === e.dataSource ? e.bc(`${this._methodName}() can only appear at the top level of your update data`) : e.bc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Cc.map(((e2) => __PRIVATE_parseData(e2, t))), r = new __PRIVATE_ArrayUnionTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.Cc, e.Cc);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Cc.map(((e2) => __PRIVATE_parseData(e2, t))), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.Cc, e.Cc);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && (this.vc === e.vc || Number.isNaN(this.vc) && Number.isNaN(e.vc));
  }
};
var __PRIVATE_NumericMinimumFieldValueImpl = class ___PRIVATE_NumericMinimumFieldValueImpl extends FieldValue {
  constructor(e, t) {
    super(e), this.vc = t;
  }
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericMinimumTransformOperation(e.serializer, toNumber(e.serializer, this.vc));
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericMinimumFieldValueImpl && (this.vc === e.vc || Number.isNaN(this.vc) && Number.isNaN(e.vc));
  }
};
var __PRIVATE_NumericMaximumFieldValueImpl = class ___PRIVATE_NumericMaximumFieldValueImpl extends FieldValue {
  constructor(e, t) {
    super(e), this.vc = t;
  }
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericMaximumTransformOperation(e.serializer, toNumber(e.serializer, this.vc));
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericMaximumFieldValueImpl && (this.vc === e.vc || Number.isNaN(this.vc) && Number.isNaN(e.vc));
  }
};
...
function _internalQueryToProtoQueryTarget(e) {
  ...
  return void 0 === n ? null : __PRIVATE_toQueryTarget(n, __PRIVATE_queryToTarget(e._query)).dt;
}
